...
import com.github.curriculeon.currencies.*;
...
public class CurrencyTypeTest {
     ...
     */
    private void test(CurrencyType expectedType, Object currencyObject) {
        // when
        CurrencyType actualType = CurrencyType.getTypeOfCurrency((ConvertableCurrency)currencyObject);
