package com.github.curriculeon.currencyconverter;

import com.github.curriculeon.ConvertableCurrency;
import com.github.curriculeon.CurrencyConverter;
import com.github.curriculeon.CurrencyType;
import com.github.curriculeon.currencies.AustralianDollar;
import com.github.curriculeon.currencies.CurrencyTestInterface;
...
public class AustralianDollarCurrencyConverterTest implements CurrencyTestInterface {
    ...
    private void testConversion(Double amountOfBaseCurrency, CurrencyType targetCurrency, Double expected) {
        // given
        ConvertableCurrency sourceCurrency = (ConvertableCurrency)new AustralianDollar();
